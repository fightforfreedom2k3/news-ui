    ...
    return(
        <Card component={'div'} onClick={()=>{}} sx={{cursor: 'pointer'}}>
            ...
            <CardContent className='text-wrapper'>
                <Stack spacing={2}>
                    {/* Title */}
                    <Typography sx={{':hover': {textDecoration: 'underline'}}} fontWeight={1000} fontSize={'28px'} lineHeight={'32px'} letterSpacing={'-0.56px'} textTransform={'none'} textOverflow={'anywhere'}>
